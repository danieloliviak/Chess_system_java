...
public class UI {
    ...
    public static final String ANSI_BLUE_DEEP = "\u001B[38;5;19m";
    ...
    private static void printPiece(ChessPiece piece, boolean background){
        if(background)System.out.print(ANSI_CYAN_BACKGROUND);
        if(piece == null) System.out.print("-"  + ANSI_RESET);
        else {
            if(piece.getColor() == Color.WHITE) System.out.print(ANSI_YELLOW + piece + ANSI_RESET);
            else System.out.print(ANSI_BLUE_DEEP + piece + ANSI_RESET);
        }
        System.out.print(" ");
    }
    private static void printCapturedPieces(List<ChessPiece> captured){
        ...
        System.out.print(ANSI_BLUE_DEEP);
